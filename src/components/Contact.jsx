    ...
    <div className="container mx-auto">
      <div className='flex flex-col lg:flex-row'>
        ...
        <motion.form variants={fadeIn('left', 0.3)}
          ...
          <textarea className='bg-transparent border-b py-12 outline-none w-full placeholder:text-white focus:border-accent transition-all' placeholder='Your message'></textarea>
