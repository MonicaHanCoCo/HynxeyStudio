...
const services = [
  {
    name: 'UI/UX Design',
    description:
      'Lorem ipsum dolor sit amet consectetur adipisicing elit.Sequi consequaturLorem ipsum dolor sit amet consectetur adipisicing elit.Sequi consequaturLorem ipsum dolor sit amet consectetur adipisicing elit.Sequi consequatur ',
    link: 'Learn more',
  },
  {
    name: 'Development',
        ...
        <motion.div variants={fadeIn('left', 0.5)}
          ...
          <div>
            {services.map((service, index) => {
              ...
              return <div className='border-b border-white/20 h-[210px] mb-[46px] flex' key={index}>
